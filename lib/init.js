...
exports.Init = {
  ...
  setupFolderTree: function() {
    ...
    basepath = "./_workshop";
    subfolders = ["./_workshop", "./_workshop/drivers", "./_workshop/scriptella", "./_workshop/liquibase", "./_workshop/logs", "./_workshop/recipes", "./_workshop/temp", "./_data", "./_src", "./_src/database_models", "./_src/elt_scripts", "./_src/etl_groups"];
