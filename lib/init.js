...
exports.Init = {
  ...
  setupFolderTree: function() {
    ...
    basepath = "./_workshop";
    subfolders = ["./_workshop/src", "./_workshop/data", "./_workshop/drivers", "./_workshop/scriptella", "./_workshop/liquibase", "./_workshop/recipes", "./_workshop/src/data", "./_workshop/src/database_models", "./_workshop/src/elt_scripts"];
