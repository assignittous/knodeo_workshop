...
exports.Liquibase = {
  setOptions: function(liquibaseOptions) {
  ...
  migrate: function(command, runParameters) {
  ...
  reverseEngineer: function(runParameters) {
