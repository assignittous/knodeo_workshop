 ...
 */
'use strict';
var CSON, baseUrl, config, configuration, convert, cwd, data_dir, fs, logger, loginAttempt, loginUrl, request, xmlParse;
...
xmlParse(loginAttempt, function(err, data) {
  var logoutXml, projectsXml, response, token;
  if (err != null) {
