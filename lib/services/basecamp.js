'use strict';
var baseUrl, basecampRequest, config, data_dir, datestamp, day, logger, output, people, people_events, people_todos, project_accesses, project_attachments, project_calendars, project_documents, project_forwards, project_todolists, project_topics, projects, request, res, serviceConfig, thisService;
...
if (projects.length > 0) {
  ...
  projects.each(function(item) {
    var attachments, calendars, documents, project, res, todolists, topics, url;
