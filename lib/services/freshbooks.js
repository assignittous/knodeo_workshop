'use strict';
var CSON, FreshBooks, api_token, api_url, attributes, category, cleanedArrayAttribute, client, configuration, convert, cwd, data_dir, datestamp, day, estimate, estimate_lines, expense, freshbooks, fs, invoice, invoice_lines, item, language, logger, output, payment, project, recurring, recurring_lines, staff, task, tax, time_entry;
