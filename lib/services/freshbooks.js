'use strict';
var CSON, FreshBooks, attributes, category, cleanedArrayAttribute, client, configuration, cwd, data_dir, datestamp, day, estimate, estimate_lines, expense, freshbooks, invoice, invoice_lines, item, language, logger, output, payment, project, recurring, recurring_lines, staff, task, tax, time_entry;
